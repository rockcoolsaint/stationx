        ...
        <div class="demo">
            <div class="login">
                <div class="login__check">
                    <img class="" src="{{ asset('images/new_analytics_logo_1.png') }}" alt="" width="325px" height="95px" style="" />
                </div>

                <form id="login-form" autocomplete="new-password" class="form-horizontal" method="POST" action="{{ route('login.custom') }}">
                        {{ csrf_field() }}
                    <div class="login__form">
                        <!--<div class="login__row login__check">
                        <img class="" src="{{ asset('images/new_analytics_logo_1.png') }}" alt="" width="325px" height="95px" style="" />
                        </div>-->
                        <p>username: admin</p>
                        <p>password: admin</p>
                        <div class="login__row">
                            ...
                            <div class="inline_input">
                                <!--USERNAME TEXT FIELD-->
                                <input autocomplete="new-password" type="text" class="login__input name" name="email" value="{{ old('email') }}" placeholder="Username" required autofocus/>
                            </div>
                        </div>
                        <div class="login__row">
                            ...
                            <div class="inline_input">
                                <!--PASSWORD TEXT FIELD-->
                                <input autocomplete="new-password" type="password" class="login__input pass" name="password" placeholder="Password" required/>
                            </div>
                        </div>
