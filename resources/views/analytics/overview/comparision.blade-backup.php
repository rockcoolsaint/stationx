<div id="monthly-comparision" class="row hidden-xs">
    <!--masonry-->
    <div class="row grid">
        <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box-margin bg-white">
                    <div class="bg-white box-margin">
                        <div class="efizzy"></div>
                        <h4 class="box-label">Revenue By Station & Location</h4>
                        <hr>
                        <div id="station-revenue-chart">
                            <span class="loading-text hide">loading...</span>
                            <canvas id="station-revenue-canvas" width="200" height="400"></canvas>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6 hidden-xs">
                        <div class="box-margin bg-white">
                            <div class="efizzy"></div>
                            <h4 class="box-label">Sales This MONTH VS Daily Target</h4>
                            <hr>
                            <div class="text-center box-content">
                                <div class="comparision-doughnut">

                                    <canvas id="comparision-doughnut-canvas"></canvas>
                                </div>
                                <div id="doughnut-monthly-target">
